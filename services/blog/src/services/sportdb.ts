...
const COMPETITIONS: Record<string, Array<{ path: string; name: string; tag?: string; surface?: string }>> = {
  ...
  tennis: [
    ...
    // ATP 500 — confirmed IDs 15 April 2026
    { path: '/api/flashscore/tennis/atp-singles:5724/rotterdam:r5DdTIZC',      name: 'Rotterdam',       tag: 'atp',            surface: 'indoor-hard' },
    { path: '/api/flashscore/tennis/atp-singles:5724/dubai:xKbLXKij',          name: 'Dubai',           tag: 'atp',            surface: 'hard' },
    { path: '/api/flashscore/tennis/atp-singles:5724/rio-de-janeiro:bZLCRom0', name: 'Rio de Janeiro',  tag: 'atp',            surface: 'clay' },
    { path: '/api/flashscore/tennis/atp-singles:5724/barcelona:rZvXbpeD',      name: 'Barcelona',       tag: 'atp',            surface: 'clay' },
    { path: '/api/flashscore/tennis/atp-singles:5724/munich:6ccef0Jo',         name: 'Munich',          tag: 'atp',            surface: 'clay' },
    { path: '/api/flashscore/tennis/atp-singles:5724/halle:0pOdQOCg',          name: 'Halle',           tag: 'atp',            surface: 'grass' },
    { path: '/api/flashscore/tennis/atp-singles:5724/london:SUpSZy5K',         name: "Queen's Club",    tag: 'atp',            surface: 'grass' },
    { path: '/api/flashscore/tennis/atp-singles:5724/hamburg:I5j9PrSa',        name: 'Hamburg',         tag: 'atp',            surface: 'clay' },
    { path: '/api/flashscore/tennis/atp-singles:5724/washington:rgTHIK74',     name: 'Washington',      tag: 'atp',            surface: 'hard' },
    { path: '/api/flashscore/tennis/atp-singles:5724/beijing:UirAofN6',        name: 'Beijing',         tag: 'atp',            surface: 'hard' },
    { path: '/api/flashscore/tennis/atp-singles:5724/tokyo:lAzP4qg4',          name: 'Tokyo',           tag: 'atp',            surface: 'hard' },
    { path: '/api/flashscore/tennis/atp-singles:5724/vienna:GvgalJQT',         name: 'Vienna',          tag: 'atp',            surface: 'indoor-hard' },
    { path: '/api/flashscore/tennis/atp-singles:5724/basel:t8icmqob',          name: 'Basel',           tag: 'atp',            surface: 'indoor-hard' },
    // Grand Slams — WTA
